...
$(function () {
    $.ajax({
        ...
        success: function (response, textStatus, jqXHR) {
            ...
            var $body = $(resHTML);
            var $tradeoffers = $body.find('.tradeoffer');
            ...
            $tradeoffers.each(function (i, o) {
                var $tradeoffer = $(this);
                if ($tradeoffer.find('.link_overlay').length == 0) return;
                ...
                $('#Div_Offers').append(tradeofferdiv);
                num++;
            });
